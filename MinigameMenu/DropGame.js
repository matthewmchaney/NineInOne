...
//To do:
//XFix the collisions with the floor from the sides
//AFix the hit roof thing (failure/move lower)
//ATweak speeds?
//-Something more
...
function DropGame(gameCanvas, gameCanvasContext, newx, newy){
	...
	this.drawFloor=function()
	{
	    for (var i = 0; i < this.floorCount; i++) {
			...
			var drawYHeight = Math.min(this.floors[i][1] + DropGame.FloorHeight, DropGame.FloorHeight);
