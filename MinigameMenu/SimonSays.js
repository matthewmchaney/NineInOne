...
drawRed = function(a)
{
	...
	stuff.lineTo((gameX + BaseSquare.SquareWidth / 2), (gameY + BaseSquare.SquareHeight / 2));
	stuff.lineTo(gameX, (gameY + BaseSquare.SquareHeight));
	stuff.closePath();
...
drawGreen = function(a)
{
	...
	stuff.moveTo(gameX, gameY);
	stuff.lineTo((gameX + BaseSquare.SquareWidth / 2), (gameY + BaseSquare.SquareHeight / 2));
	stuff.lineTo((gameX + BaseSquare.SquareWidth), gameY);
	stuff.closePath();
...
{
	stuff.beginPath();
	stuff.moveTo((gameX + BaseSquare.SquareWidth), gameY);
	stuff.lineTo((gameX + BaseSquare.SquareWidth / 2), (gameY + BaseSquare.SquareHeight / 2));
	stuff.lineTo((gameX + BaseSquare.SquareWidth), (gameY + BaseSquare.SquareHeight));
	stuff.closePath();
...
{
	stuff.beginPath();
	stuff.moveTo(gameX, (gameY + BaseSquare.SquareHeight));
	stuff.lineTo((gameX + BaseSquare.SquareWidth / 2), (gameY + BaseSquare.SquareHeight / 2));
	stuff.lineTo((gameX + BaseSquare.SquareWidth), (gameY + BaseSquare.SquareHeight));
	stuff.closePath();
...
SimonSays.prototype.draw = function()
{
