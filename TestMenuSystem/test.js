...
function GetGameName(num)
{
	switch(num)
	{
		case GamesEnum.GAME1:
		return "Game1";
		case GamesEnum.GAME2:
		return "Game2";
		case GamesEnum.GAME3:
		return "Game3";
	}
}
...
function InitializeGame()
{
	...
	{
		case GamesEnum.GAME1:
			square = new Example1Game(canvas, canvasContext, (CANVAS_WIDTH - BaseSquare.SquareWidth) / 2, (CANVAS_HEIGHT - BaseSquare.SquareHeight) / 2);
			break;
		case GamesEnum.GAME2:
			square = new Example2Game(canvas, canvasContext, (CANVAS_WIDTH - BaseSquare.SquareWidth) / 2, (CANVAS_HEIGHT - BaseSquare.SquareHeight) / 2);
			break;
		case GamesEnum.GAME3:
...
function draw() {
	switch(menu_state)
	{
		case MenuStateEnum.MAIN:
			...
			canvasContext.fillText("Play Game",50,70);
			//canvasContext.fillText("Highscores",50,90);
			canvasContext.fillText("About",50,90);
			canvasContext.fillText(">", 40, 70 + _selectIndex * 20);
		break;
		case MenuStateEnum.PLAY:
			canvasContext.fillStyle = "#EEF";
			canvasContext.fillRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
		...
		case MenuStateEnum.GAMEOVER:
			...
			canvasContext.fillStyle = "#000";
			canvasContext.fillText("Game Over",50,70);
			canvasContext.fillText("Space to retry",50,90);
			canvasContext.fillText("Esc to quit",50,110);
		...
		case MenuStateEnum.ABOUT:
			...
			canvasContext.fillStyle = "#000";
			//canvasContext.font="20px Georgia";
			canvasContext.fillText("Names Go Here",50,70);
		break;
		case MenuStateEnum.HIGHSCORES:
			canvasContext.fillStyle = "#EEF";
			canvasContext.fillRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
		...
		case MenuStateEnum.GAMESELECT:
			...
			canvasContext.fillStyle = "#000";
			//canvasContext.font="20px Georgia";
			canvasContext.fillText("Game Select",50,70);
			canvasContext.fillText(GetGameName(_gameChoice),50,110);
		break;
	}
