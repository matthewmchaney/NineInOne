//SingleSquareIncludes.js writes the files that need to be included into the main html file. When you make a game, you'll need to add yours here
...
document.write('<script type="text/javascript" src="DropGame.js"></script>');
